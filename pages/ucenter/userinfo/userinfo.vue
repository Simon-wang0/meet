<template>
    <view>
        <uni-list>
            ...
            <uni-list-item class="item"  :title="$t('userinfo.username')"
                :rightText="userInfo.username||$t('userinfo.notSet')" link>
            </uni-list-item>
            ...
            <uni-list-item class="item"  :title="$t('userinfo.sex')"
                :rightText="userInfo.gender==1?'男':'女'||$t('userinfo.notSet')" link>
            </uni-list-item>
            <uni-list-item class="item" @click="setCompany('')" :title="$t('userinfo.company')"
                :rightText="userInfo.company||$t('userinfo.notSet')" link>
            </uni-list-item>
            <uni-list-item class="item" @click="" :title="$t('userinfo.school')"
                :rightText="userInfo.school||$t('userinfo.notSet')" link>
            </uni-list-item>
            <uni-list-item class="item" @click="" :title="$t('userinfo.address')"
                :rightText="userInfo.address||$t('userinfo.notSet')" link>
            </uni-list-item>
        </uni-list>
        <uni-popup ref="dialog" type="dialog">
            <uni-popup-dialog mode="input" :value="userInfo.nickname" @confirm="setCompany"
                :title="$t('userinfo.setCompany')" :placeholder="$t('userinfo.setCompany')">
            </uni-popup-dialog>
        </uni-popup>
